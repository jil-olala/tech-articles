...
**作者**: 阿里云开发者  
**发布日期**: 2026-07-06  
**原文链接**: https://mp.weixin.qq.com/s/9qEgOV9FGk6u9_9zMLSI6A

---

![image](images/autoresearch-llm/img-01.png)
阿里妹导读
...
![image](images/autoresearch-llm/img-02.png)
1. 背景
**1.1 缘起**
...
```
![image](images/autoresearch-llm/img-03.png)
**2.1 第一阶段：场景理解与基线分析**
...
任务被调度到训练队列
```
![image](images/autoresearch-llm/img-04.png)
...
```
| predict BLEU 异常低（ 标签 | Qwen3 thinking mode 未关。加 --enable_thinking=False |
```
...
![image](images/autoresearch-llm/img-05.png)
项目
入门门槛
适用领域
训练框架
