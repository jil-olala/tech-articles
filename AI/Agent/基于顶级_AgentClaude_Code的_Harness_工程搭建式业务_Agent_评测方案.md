...
- **作者：** 阿里云开发者
- **日期：** 2026-06-05
- **原文链接：** https://mp.weixin.qq.com/s/n9zkbKTi3Q1j-L2vgmO1Vw

---

![image](images/harness-agent-eval/img-01.jpg)
...
## 二、Harness 工程整体架构
**2.1 三层架构**
![image](images/harness-agent-eval/img-02.png)
**2.2 Harness 搭建五步法**
![image](images/harness-agent-eval/img-03.png)
**2.3 与传统评测工程的类比**
传统评测工程
Harness 式评测
变化
...
## 三、统一评测指标框架
**3.1 三层指标体系**
![image](images/harness-agent-eval/img-04.png)
...
**（CC 角色：Harness 工程师）**
![image](images/harness-agent-eval/img-05.png)
...
## 六、效率对比
![image](images/harness-agent-eval/img-06.png)
**6.1 时间投入**
阶段
传统方式
CC 协助
