...
- **作者：** 腾讯云开发者
- **日期：** 2026-04-29
- **原文链接：** https://mp.weixin.qq.com/s/8PwDQSX7ZX6HdDiW-H9Dzg
...
![image](images/harness_engineering/img-01.png)
...
![image](images/harness_engineering/img-02.png)
...
![image](images/harness_engineering/img-03.png)
...
![image](images/harness_engineering/img-04.png)
...
![image](images/harness_engineering/img-05.png)
...
![image](images/harness_engineering/img-06.png)
...
![image](images/harness_engineering/img-07.png)
...
![image](images/harness_engineering/img-08.png)
...
![image](images/harness_engineering/img-09.png)

命令风险分类

根据命令类型、参数和影响，自动评估其风险等级（安全、有风险、危险），并采取自动执行、请求确认或直接拦截等不同策略。

![image](images/harness_engineering/img-10.png)

单用途工具设计

将常用操作（如读文件、搜索）封装为专用工具，而非依赖通用Shell命令，以提高可理解性、可审查性和权限控制粒度。

![image](images/harness_engineering/img-11.png)
...
![image](images/harness_engineering/img-12.png)
...
![image](images/harness_engineering/img-13.png)
...
![image](images/harness_engineering/img-14.png)
...
![image](images/harness_engineering/img-15.png)
...
![image](images/harness_engineering/img-16.png)
...
![image](images/harness_engineering/img-17.png)
...
![image](images/harness_engineering/img-18.png)

   3.1 五段式循环

规划 → 执行 → 观察 → 学习 → 适应

![image](images/harness_engineering/img-19.png)

   3.2 五层记忆架构

![image](images/harness_engineering/img-20.png)
...
![image](images/harness_engineering/img-21.png)
